...
function stopAllAudio(){
  [fan, song, carAudio2].forEach(a => { a.pause(); a.currentTime = 0; });
...
const blurryItems = [
  ...
  {type:'image', media:'images/blurry06.jpeg', audio:'audio/fine-shit06.mp3'}
];
...
blurryNext.addEventListener('click', startCinematic);
